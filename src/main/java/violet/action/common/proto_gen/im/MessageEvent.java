...
public final class MessageEvent extends
        ...
        try {
            ...
            while (!done) {
                ...
                switch (tag) {
                    ...
                    case 10: {
                        violet.action.common.proto_gen.im.MessageBody.Builder subBuilder = null;
                        if (msgBody_ != null) {
                            subBuilder = msgBody_.toBuilder();
                        }
                        msgBody_ = input.readMessage(violet.action.common.proto_gen.im.MessageBody.parser(), extensionRegistry);
                        if (subBuilder != null) {
    ...
    getDescriptor() {
        return violet.action.common.proto_gen.im.Im.internal_static_im_MessageEvent_descriptor;
    }

    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
    internalGetFieldAccessorTable() {
        return violet.action.common.proto_gen.im.Im.internal_static_im_MessageEvent_fieldAccessorTable
                .ensureFieldAccessorsInitialized(
                        violet.action.common.proto_gen.im.MessageEvent.class, violet.action.common.proto_gen.im.MessageEvent.Builder.class);
    }

    public static final int MSG_BODY_FIELD_NUMBER = 1;
    private violet.action.common.proto_gen.im.MessageBody msgBody_;
     ...
     * <code>.im.MessageBody msg_body = 1;</code>
     */
    public violet.action.common.proto_gen.im.MessageBody getMsgBody() {
        return msgBody_ == null ? violet.action.common.proto_gen.im.MessageBody.getDefaultInstance() : msgBody_;
    }

    /**
     * <code>.im.MessageBody msg_body = 1;</code>
     */
    public violet.action.common.proto_gen.im.MessageBodyOrBuilder getMsgBodyOrBuilder() {
        return getMsgBody();
    }
    ...
    public boolean equals(final java.lang.Object obj) {
        ...
        if (!(obj instanceof violet.action.common.proto_gen.im.MessageEvent)) {
            return super.equals(obj);
        }
        violet.action.common.proto_gen.im.MessageEvent other = (violet.action.common.proto_gen.im.MessageEvent) obj;
    ...
    public static violet.action.common.proto_gen.im.MessageEvent parseFrom(
    ...
    public static violet.action.common.proto_gen.im.MessageEvent parseFrom(byte[] data)
            throws com.google.protobuf.InvalidProtocolBufferException {
        return PARSER.parseFrom(data);
    }
    ...
    public static violet.action.common.proto_gen.im.MessageEvent parseFrom(java.io.InputStream input)
            throws java.io.IOException {
    ...
    public static violet.action.common.proto_gen.im.MessageEvent parseDelimitedFrom(java.io.InputStream input)
            throws java.io.IOException {
        return com.google.protobuf.GeneratedMessageV3
                .parseDelimitedWithIOException(PARSER, input);
    }

    public static violet.action.common.proto_gen.im.MessageEvent parseDelimitedFrom(
            java.io.InputStream input,
            com.google.protobuf.ExtensionRegistryLite extensionRegistry)
            throws java.io.IOException {
        return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(violet.action.common.proto_gen.im.MessageEvent prototype) {
    ...
    public static final class Builder extends
            ...
            violet.action.common.proto_gen.im.MessageEventOrBuilder {
        public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
            return violet.action.common.proto_gen.im.Im.internal_static_im_MessageEvent_descriptor;
        }
        ...
        // Construct using violet.action.common.proto_gen.im.MessageEvent.newBuilder()
        private Builder() {
        ...
        public violet.action.common.proto_gen.im.MessageEvent getDefaultInstanceForType() {
            return violet.action.common.proto_gen.im.MessageEvent.getDefaultInstance();
        }

        public violet.action.common.proto_gen.im.MessageEvent build() {
            violet.action.common.proto_gen.im.MessageEvent result = buildPartial();
        ...
        public violet.action.common.proto_gen.im.MessageEvent buildPartial() {
            violet.action.common.proto_gen.im.MessageEvent result = new violet.action.common.proto_gen.im.MessageEvent(this);
            if (msgBodyBuilder_ == null) {
        ...
        public Builder mergeFrom(com.google.protobuf.Message other) {
            if (other instanceof violet.action.common.proto_gen.im.MessageEvent) {
                return mergeFrom((violet.action.common.proto_gen.im.MessageEvent) other);
            } else {
        ...
        public Builder mergeFrom(violet.action.common.proto_gen.im.MessageEvent other) {
            if (other == violet.action.common.proto_gen.im.MessageEvent.getDefaultInstance()) return this;
            if (other.hasMsgBody()) {
        ...
        public Builder mergeFrom(
                ...
                com.google.protobuf.ExtensionRegistryLite extensionRegistry)
                throws java.io.IOException {
            violet.action.common.proto_gen.im.MessageEvent parsedMessage = null;
            try {
                parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
            } catch (com.google.protobuf.InvalidProtocolBufferException e) {
                parsedMessage = (violet.action.common.proto_gen.im.MessageEvent) e.getUnfinishedMessage();
        ...
        private violet.action.common.proto_gen.im.MessageBody msgBody_ = null;
        private com.google.protobuf.SingleFieldBuilderV3<
                violet.action.common.proto_gen.im.MessageBody, violet.action.common.proto_gen.im.MessageBody.Builder, violet.action.common.proto_gen.im.MessageBodyOrBuilder> msgBodyBuilder_;
         ...
         * <code>.im.MessageBody msg_body = 1;</code>
         */
        public Builder setMsgBody(violet.action.common.proto_gen.im.MessageBody value) {
            if (msgBodyBuilder_ == null) {
                if (value == null) {
         ...
         * <code>.im.MessageBody msg_body = 1;</code>
         */
        public Builder mergeMsgBody(violet.action.common.proto_gen.im.MessageBody value) {
            if (msgBodyBuilder_ == null) {
                if (msgBody_ != null) {
                    msgBody_ =
                            violet.action.common.proto_gen.im.MessageBody.newBuilder(msgBody_).mergeFrom(value).buildPartial();
                } else {
                    msgBody_ = value;
                }
                onChanged();
         ...
         * <code>.im.MessageBody msg_body = 1;</code>
         */
        public violet.action.common.proto_gen.im.MessageBody.Builder getMsgBodyBuilder() {
        ...
        public violet.action.common.proto_gen.im.MessageBodyOrBuilder getMsgBodyOrBuilder() {
            if (msgBodyBuilder_ != null) {
                ...
                return msgBody_ == null ?
                        violet.action.common.proto_gen.im.MessageBody.getDefaultInstance() : msgBody_;
            }
        }
    ...
    private static final violet.action.common.proto_gen.im.MessageEvent DEFAULT_INSTANCE;

    static {
        DEFAULT_INSTANCE = new violet.action.common.proto_gen.im.MessageEvent();
    }

    public static violet.action.common.proto_gen.im.MessageEvent getDefaultInstance() {
