...
public interface MessageGetByInitResponseOrBuilder extends
     ...
     */
    java.util.List<violet.action.common.proto_gen.im.ConversationMessage>
    getConsList();

    /**
     * <code>repeated .im.ConversationMessage cons = 1;</code>
     */
    violet.action.common.proto_gen.im.ConversationMessage getCons(int index);
     ...
     * <code>repeated .im.ConversationMessage cons = 1;</code>
     */
    java.util.List<? extends violet.action.common.proto_gen.im.ConversationMessageOrBuilder>
    getConsOrBuilderList();

    /**
     * <code>repeated .im.ConversationMessage cons = 1;</code>
     */
    violet.action.common.proto_gen.im.ConversationMessageOrBuilder getConsOrBuilder(
            int index);
